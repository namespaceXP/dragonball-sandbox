...
mod tests {
    ...
    use super::super::super::backend::VsockUnixBackend;
    ...
    impl MuxerTestContext {
        fn new(name: &str) -> Self {
            ...
            let uds_backend = Box::new(VsockUnixBackend::new(host_sock_path.clone()).unwrap());
    ...
    fn test_add_backend_to_muxer() {
        ...
        let uds_backend_1 = Box::new(VsockUnixBackend::new(host_sock_path_1.clone()).unwrap());
        let uds_backend_2 = Box::new(VsockUnixBackend::new(host_sock_path_2.clone()).unwrap());
        ...
        let uds_backend_3 = Box::new(VsockUnixBackend::new(host_sock_path_3.clone()).unwrap());
