...
mod tests {
    ...
    fn test_unix_backend_bind() {
        ...
        assert!(VsockUnixBackend::new(host_sock_path.clone()).is_ok());
    ...
    fn test_unix_backend_accept() {
        ...
        let mut vsock_backend = VsockUnixBackend::new(host_sock_path.clone()).unwrap();
    ...
    fn test_unix_backend_connect() {
        ...
        let vsock_backend = VsockUnixBackend::new(host_sock_path.clone()).unwrap();
